 ...
 *
 * Disassembly of ssdt6.dat, Sat Apr  3 03:42:51 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00004C82 (19586)
 *     Revision         0x02
 *     Checksum         0x13
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    External (_SB_.PCI0.GEXP.GEPS, IntObj)
    ...
    OperationRegion (SANV, SystemMemory, 0xCBB6AD98, 0x0135)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (SGPI, 4, Serialized)
        {
            ...
            ElseIf ((Arg0 == 0x02))
            {
                ...
                {
                    Arg1 = \_SB.PCI0.GEXP.GEPS /* External reference */
                    Arg2
                    Local0
                }
            }
